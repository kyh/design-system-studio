...
Design Tokens define the visual characteristics of a brand or a product such as typography, colors, icons, and spacing. They make it easier to maintain a scalable, consistent system for UI development. Proto maintains all default design tokens in the `@dss/tokens` package.
