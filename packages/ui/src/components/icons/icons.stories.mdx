...
<Preview withSource="open">
  <Story name="usage">
    <Icons.CheckboxChecked title="checkbox checked" color="ui.color" />
  </Story>
</Preview>
...
<Preview>
  <Story name="sizing with font-size">
    <Flex alignItems="center">
      <Icons.Loader fontSize="body" mr={2} color="ui.color" aria-hidden />
      <Icons.Loader fontSize="heading" mr={2} color="ui.color" aria-hidden />
    </Flex>
  </Story>
</Preview>
...
<Preview>
  <Story name="sizing with layout props">
    <Icons.Loader width={3} height={3} color="ui.color" aria-hidden />
  </Story>
</Preview>
...
<Preview withSource="open">
  <Story name="as decorative">
    <Icons.RadioChecked color="ui.color" aria-hidden />
  </Story>
</Preview>
...
<Preview withSource="open">
  <Story name="as non-decorative">
    <Icons.Loader color="ui.color" title="waiting for content to load" />
  </Story>
</Preview>
